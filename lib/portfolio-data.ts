...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'An AI-powered textile platform that transforms text inputs into adjustable fabric patterns through real-time generative interaction and control.',
